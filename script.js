...
const images = [
    ...
    "img-4998.jpg",
    "img-1807.jpg",
    "3554f274-64cc-4da7-91eb-b1b43adc9725.jpg",
    "img-3528.jpg",
    "img-1016.jpg",
    "img-8021.jpg",
    "img-3863.jpg",
    ...
    "eaeb8008-f99f-4c0a-a7d5-40b0831eb4db.png",
    "img-1029.jpg",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    images.forEach((img, index) => {
        ...
        item.innerHTML = `<img src="images/thumb/${img}" alt="Memory of Jeff" loading="lazy" decoding="async">`;
